...
func (x *UpdateUserPasswordResp) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
const file_user_proto_rawDesc = "" +
	...
	"\x03sex\x18\x06 \x01(\x05R\x03sex\x12\x14\n" +
	"\x05email\x18\a \x01(\tR\x05email\"\x1d\n" +
	"\aRequest\x12\x12\n" +
	...
	"\x16UpdateUserPasswordResp\x12\x18\n" +
	...
	"\bFindUser\x12\x11.user.FindUserReq\x1a\x12.user.FindUserResp\x12L\n" +
	"\x11UpdateUserProfile\x12\x1a.user.UpdateUserProfileReq\x1a\x1b.user.UpdateUserProfileResp\x12O\n" +
	"\x12UpdateUserPassword\x12\x1b.user.UpdateUserPasswordReq\x1a\x1c.user.UpdateUserPasswordRespB\bZ\x06./userb\x06proto3"
...
var file_user_proto_goTypes = []any{
	...
	(*UpdateUserPasswordReq)(nil),  // 13: user.UpdateUserPasswordReq
	(*UpdateUserPasswordResp)(nil), // 14: user.UpdateUserPasswordResp
}
var file_user_proto_depIdxs = []int32{
	...
	13, // 8: user.User.UpdateUserPassword:input_type -> user.UpdateUserPasswordReq
	2,  // 9: user.User.Ping:output_type -> user.Response
	4,  // 10: user.User.Login:output_type -> user.LoginResp
	6,  // 11: user.User.Register:output_type -> user.RegisterResp
	8,  // 12: user.User.GetUserInfo:output_type -> user.GetUserInfoResp
	10, // 13: user.User.FindUser:output_type -> user.FindUserResp
	12, // 14: user.User.UpdateUserProfile:output_type -> user.UpdateUserProfileResp
	14, // 15: user.User.UpdateUserPassword:output_type -> user.UpdateUserPasswordResp
